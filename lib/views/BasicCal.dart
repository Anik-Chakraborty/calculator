...
class BasicCal extends StatefulWidget {
  const BasicCal({Key? key}) : super(key: key);

  @override
  State<BasicCal> createState() => _BasicCalState();
}

class _BasicCalState extends State<BasicCal> {
                    ...
                    children: [
                      Column(
                        children: [
                          ...
                          calcButton(context, '7', Colors.grey, () => buttonPressed('7')),
                          SizedBox(height: MediaQuery.of(context).size.width * 0.01),
                          calcButton(context, '4', Colors.grey, () => buttonPressed('4')),
                          SizedBox(height: MediaQuery.of(context).size.width * 0.01),
                          calcButton(context, '1', Colors.grey, () => buttonPressed('1')),
                          SizedBox(height: MediaQuery.of(context).size.width * 0.01),
                          calcButton(context, '0', Colors.grey, () => buttonPressed('0')),
                        ],
                      ),
                      ...
                      Column(
                        children: [
                          ...
                          SizedBox(height: MediaQuery.of(context).size.width * 0.01),
                          calcButton(context, '8', Colors.grey, () => buttonPressed('8')),
                          SizedBox(height: MediaQuery.of(context).size.width * 0.01),
                          calcButton(context, '5', Colors.grey, () => buttonPressed('5')),
                          SizedBox(height: MediaQuery.of(context).size.width * 0.01),
                          calcButton(context, '2', Colors.grey, () => buttonPressed('2')),
                          SizedBox(height: MediaQuery.of(context).size.width * 0.01),
                      ...
                      Column(
                        children: [
                          calcButton(context, '÷', Colors.black, () => buttonPressed('÷')),
                          SizedBox(height: MediaQuery.of(context).size.width * 0.01),
                          calcButton(context, '9', Colors.grey, () => buttonPressed('9')),
                          SizedBox(height: MediaQuery.of(context).size.width * 0.01),
                          calcButton(context, '6', Colors.grey, () => buttonPressed('6')),
                          SizedBox(height: MediaQuery.of(context).size.width * 0.01),
                          calcButton(context, '3', Colors.grey, () => buttonPressed('3')),
                          SizedBox(height: MediaQuery.of(context).size.width * 0.01),
                          calcButton(context, '+/-', Colors.grey, () => buttonPressed('+/-')),
                        ],
                      ),
